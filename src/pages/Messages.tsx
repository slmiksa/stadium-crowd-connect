...
const Messages = () => {
  ...
  return <Layout>
      <div className="p-4">
        ...
        {activeTab === 'messages' && <button onClick={() => navigate('/chat-rooms')} className="fixed bottom-24 right-4 w-14 h-14 bg-blue-500 rounded-full flex items-center justify-center shadow-lg hover:bg-blue-600 transition-colors">
